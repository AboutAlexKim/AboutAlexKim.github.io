...
export const works = [
    ...
    { title: 'Current Portfolio Website', description: "Independently created/developed a new and improved personal portfolio web application designed primarily through a React front-end. Began exploring a variety of back-end technologies for the application with one particular example being Firebase, which I hope to implement in the near future and as I continue to update the website.", imgUrl: images.Project19, projectLink: 'https://github.com/er9fa/IPPFA21-alpha', tag: ['Front-End', 'All'] },
