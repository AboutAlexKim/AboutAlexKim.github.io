...
export const works = [
    ...
    { title: 'Current Portfolio Website', description: "Independently created/developed a new and improved personal portfolio web application designed primarily through a React front-end. Began exploring a variety of back-end technologies for the application with one particular example being Firebase, which I hope to implement in the near future and as I continue to update the website.", imgUrl: images.Project19, projectLink: 'https://github.com/ajk3158/AboutAlexKim.github.io', tag: ['Front-End', 'All'] },

    { title: 'Home Collateral Estimation ML Model', description: "Created a Home Collateral Estimation ML Model for banks to use in professional/personal financing operations through regression ML models, data prep/cleaning, and parameter hyper tuning. Wrote Technical Report on work and development process (as seen in image) and can be found at the top of the code.", imgUrl: images.Project12, projectLink: 'https://drive.google.com/file/d/1d1YVBRNX4822Q4DbWUnVC0t2D-gfI26y/view?usp=sharing', tag: ['ML/AI', 'Data Science', 'All'] },
